<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"C:\Users\hp\Desktop\ceshi\public/../application/admin\view\notice\index.html";i:1524234305;s:77:"C:\Users\hp\Desktop\ceshi\public/../application/admin\view\public\header.html";i:1509346268;s:77:"C:\Users\hp\Desktop\ceshi\public/../application/admin\view\public\footer.html";i:1509346268;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<blockquote class="layui-elem-quote admin_index_nav">
    ...
    <div class="layui-inline">
        <a class="layui-btn layui-btn-normal add_tip_btn"><i class="layui-icon">&#xe654;</i> 新增</a>
    </div>
</blockquote>
...
<script type="text/javascript" >
    layui.use(['layer','jquery','laypage','table','form'],function(){
        ...
        table.render({
            elem: '#table_said'
            ,url: "<?php echo url('Notice/index'); ?>"
            ,height:399
            ,cols: [[
                {checkbox: true, fixed: true}
                ,{field:'id', title: 'ID', width:100, sort: true}
                ,{field:'tip_os', title: '发布设备', width:100}
                ,{field:'tip_address', title: '发布地址', width:130}
                ,{field:'tip_status', title: '状态', width:100,templet: '#statusTpl'}
        ...
        table.on('tool(said)', function(obj){
            var data = obj.data;
          if(obj.event === 'del'){
              layer.confirm('确定删除此条通告？',{icon:3, title:'提示信息'},function(index){
                  var id = data.id;
                  $.post("<?php echo url('Notice/delete'); ?>",{id:id},function(res){
                      if(res.code==1){
                          layer.msg(res.msg,{
                              time:1500,
                              icon:1
              ...
              var index = layer.open({
                  ...
                  success : function(){
                      setTimeout(function(){
                         layer.tips('点击此处返回网站通告列表', '.layui-layer-setwin .layui-layer-close',{time:1500}, {
                              tips: 3
                          });
                      },500)
                  }
        ...
        $(".add_tip_btn").click(function(){
            var index = layer.open({
                title : "添加网站通知",
                type : 2,
                content : "<?php echo url('Notice/add'); ?>",
                success : function(layero, index){
                    setTimeout(function(){
                        layer.tips('点击此处返回我的通知列表', '.layui-layer-setwin .layui-layer-close',{time:1500}, {
                            tips: 3
                        });
                    },500)
                }
